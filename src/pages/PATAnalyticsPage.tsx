...
export default function PATAnalyticsPage() {
  ...
  const { data, isLoading } = trpc.pat.getAnalytics.useQuery();
            ...
            <>
              ...
              <div className="grid lg:grid-cols-2 gap-6 mb-8">
                ...
                <Card className="bg-[var(--page-surface)] border-[var(--border-color)]">
                  <CardContent className="p-5">
                    <h2 className="text-sm font-semibold text-[var(--text-primary)] mb-4">
                      Progress Trend (Last {Math.min(10, data!.trend.length)}{" "}
                      Sessions)
                    </h2>
                    {data!.trend.length === 0 ? (
                        ...
                        {data!.strengths.length === 0 ? (
                          ...
                          data!.strengths.map(s => (
                            ...
                            >
                              ...
                              {categoryMeta[s.category]?.label ?? s.category} (
                              {s.accuracy}% accuracy)
                            </li>
                          ))
                        )}
                        ...
                        {data!.weaknesses.length === 0 ? (
                          ...
                          data!.weaknesses.map(w => (
                            ...
                            >
                              ...
                              {categoryMeta[w.category]?.label ?? w.category} (
                              {w.accuracy}%) - {w.action}
                            </li>
                          ))
                        )}
