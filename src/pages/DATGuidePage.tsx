    ...
    breakdown: [
      {
        subject: "Biology",
        questions: 40,
        topics: "Cell Biology, Physiology, Ecology, Microbiology, Anatomy",
      },
      {
        subject: "Chemistry",
        questions: 30,
        topics: "General Chemistry (NO Organic Chemistry on Canadian DAT)",
      },
    ],
    ...
    breakdown: [
      {
        subject: "Keyholes",
        questions: 15,
        topics: "Spatial visualization of 3D objects through 2D apertures",
      },
      {
        subject: "Top-Front-End",
        questions: 15,
        topics: "Orthographic projection and visualization",
      },
      {
        subject: "Angle Ranking",
        questions: 15,
        topics: "Compare and rank 4 angles from smallest to largest",
      },
      {
        subject: "Hole Punching",
        questions: 15,
        topics: "Mental unfolding of folded paper with punch marks",
      },
      {
        subject: "Cube Counting",
        questions: 15,
        topics: "Count painted faces on stacked cubes",
      },
      {
        subject: "Pattern Folding",
        questions: 15,
        topics: "2D net to 3D form visualization",
      },
    ],
    ...
    breakdown: [
      {
        subject: "3 Passages",
        questions: 50,
        topics: "Scientific passages, ~16 paragraphs each",
      },
    ],
...
const scoringScale = [
  {
    score: "30",
    percentile: "99.9th",
    description: "Perfect score - exceptionally rare",
  },
  {
    score: "25-29",
    percentile: "95-99th",
    description: "Excellent - top tier applicants",
  },
  {
    score: "22-24",
    percentile: "80-95th",
    description: "Competitive - above average",
  },
  {
    score: "20-21",
    percentile: "65-80th",
    description: "Good - meets most school requirements",
  },
  {
    score: "18-19",
    percentile: "45-65th",
    description: "Average - acceptable for some schools",
  },
  {
    score: "Below 18",
    percentile: "Below 45th",
    description: "Below average - consider retaking",
  },
];
...
const competitiveScores = [
  {
    ...
    minAA: "21+",
    minPAT: "20+",
    notes: "High competition, strong applicants",
  },
  {
    school: "Western",
    minAA: "20+",
    minPAT: "19+",
    notes: "Balanced evaluation",
  },
  {
    school: "McGill",
    minAA: "20+",
    minPAT: "19+",
    notes: "MMI interview heavy",
  },
  { school: "UBC", minAA: "20+", minPAT: "19+", notes: "MMI+SGI format" },
  {
    ...
    minAA: "20+",
    minPAT: "19+",
    notes: "Strong IP preference",
  },
  {
    school: "Saskatchewan",
    minAA: "19+",
    minPAT: "18+",
    notes: "Higher OOP requirements",
  },
];
      ...
      <div className="pt-20 pb-12 bg-gradient-to-br from-[var(--page-bg)] to-[var(--page-surface)]">
        <div className="section-container max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#F59E0B] to-[#EF4444] flex items-center justify-center">
              <BookOpen className="w-7 h-7 text-white" />
            </div>
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-[var(--text-primary)]">
                Complete Canadian DAT Guide
              </h1>
              <p className="text-[var(--text-secondary)]">
                Everything you need to know about the Canadian DAT.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 p-4 rounded-lg bg-[var(--page-muted)] border border-[var(--border-color)] flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-secondary)]">
              ...
              Quantitative Reasoning. Many US prep resources waste your time on
              these topics. Use Canadian-specific materials.
            </p>
          </div>
        </div>
        ...
        <Card className="border-[var(--border-color)] mb-8">
          <CardContent className="p-6">
            <h2 className="text-xl font-bold text-[var(--text-primary)] mb-4">
              Canadian DAT Test Format
            </h2>
            <div className="space-y-6">
              {sections.map(section => (
                <div
                  key={section.name}
                  className="border-b border-[var(--border-color)] last:border-0 pb-6 last:pb-0"
                >
                  ...
                  <div className="space-y-2 mb-3">
                    {section.breakdown.map(b => (
                      <div
                        key={b.subject}
                        className="flex items-start gap-3 p-3 rounded-lg bg-[var(--page-bg)]"
                      >
                        <div className="flex-1">
                          <p className="text-sm font-medium text-[var(--text-primary)]">
                            {b.subject}
                          </p>
                          <p className="text-xs text-[var(--text-secondary)]">{b.topics}</p>
                        </div>
                        <Badge className="shrink-0 bg-[var(--page-muted)] text-[#2563EB]">
                          {b.questions}Q
                        </Badge>
                      </div>
                    ))}
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-[var(--page-muted)]">
                    <Info className="w-4 h-4 text-[#2563EB] mt-0.5 shrink-0" />
                    <p className="text-xs text-[var(--text-secondary)]">{section.tip}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-2">
              {scoringScale.map(s => (
                <div
                  key={s.score}
                  className="flex items-center gap-4 p-3 rounded-lg hover:bg-[var(--page-bg)] transition-colors"
                >
                ...
                <tbody>
                  {competitiveScores.map(s => (
                    ...
                    >
                      ...
                      <td className="py-2.5 px-3 text-sm text-center text-[#2563EB] font-semibold">
                        {s.minAA}
                      </td>
                      <td className="py-2.5 px-3 text-sm text-center text-[#8B5CF6] font-semibold">
                        {s.minPAT}
                      </td>
          ...
          <CardContent className="p-6">
            ...
            <ol className="space-y-3">
              {[
                ...
                "Pay the registration fee (check the CDA website for current pricing)",
